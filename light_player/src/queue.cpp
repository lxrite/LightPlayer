...
PacketQueue::PacketQueue() : serial(std::make_shared<int>(0)) {}

PacketQueue::~PacketQueue() {}

auto PacketQueue::Serial() const -> int { return *serial; }
...
auto PacketQueue::Empty() -> bool { return packet_list.empty(); }

auto PacketQueue::Size() -> std::size_t { return packet_list.size(); }
...
auto FrameQueue::Empty() -> bool { return frame_list.empty(); }

auto FrameQueue::Size() -> std::size_t { return frame_list.size(); }
...
auto FrameQueue::Clear() -> void { frame_list.clear(); }
