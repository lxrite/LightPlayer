...
Decoder::Decoder(AVCodecContext *codec_ctx) : codec_ctx_(codec_ctx) {}
Decoder::~Decoder() { avcodec_free_context(&codec_ctx_); }
...
auto Decoder::GetCodecContext() const -> AVCodecContext * { return codec_ctx_; }

auto Decoder::FlushBuffers() -> void { avcodec_flush_buffers(codec_ctx_); }

auto Decoder::OpenDecoder(const AVCodecParameters *codecpar,
